...
function Contact() {
  ...
  return (
    <div>
      <h1 style={{color : myColor}}>Contact</h1><br/>
      ...
      <button className="btn btn-info" onClick={() => {setMyColor('aqua')}}>Click</button><br/>
      <div>
      <h1>{username}</h1>
      <button className="btn btn-success" onClick={handleClick}>Click Me</button><br/></div>
